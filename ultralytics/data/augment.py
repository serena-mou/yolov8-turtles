...
class Albumentations:
    ...
    def __init__(self, p=1.0,size=640):
        ...
        try:
            ...
            '''
            T = [
                A.RandomResizedCrop(height=640, width=640, scale=(0.9, 1.0), ratio=(0.9, 1.1), p=0.8),
                A.ColorJitter(brightness=0.1, contrast=0.1, saturation=0.05, hue=0.1, p=0.8),
                A.RandomRotate90(p=0.8)]  # transforms
